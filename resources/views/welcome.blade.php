...
<body x-data="{open:false}">
            ...
            <section class="w-[396px] shrink-0 flex flex-col gap-6 mx-auto">
                <div class=" bg-white py-5 px-4 shadow-lg rounded-md flex flex-col gap-4">
                    <form action="#" class="flex flex-col gap-4">
                        <input type="text" placeholder="Email or phone number" id="login_email"
                            class="border border-gray-300 py-4 px-3 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500">
                        <input type="password" placeholder="Password"
                            class="border border-gray-300 py-4 px-3 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500">
                        <button type="submit" class="bg-blue-500 text-white text-xl py-3 rounded-md font-bold">Log in</button>
                    </form>
    ...
    <form action="#"
        ...
        :class="{'!block': open}"
        x-show="open">
        <img src="{{ asset('assets/close.png') }}" alt="close button" class="absolute top-4 right-3 block w-5" @click="open=false">
        ...
        <div class="flex flex-col gap-1 mb-2">
            ...
            <div class="flex gap-3">
                <select name="birthday_month" id="birthday_month" class="p-1.5 border border-gray-300 rounded-sm flex-1">
                ...
                <select name="birthday_day" id="birthday_day" class="p-1.5 border border-gray-300 rounded-sm flex-1">
                ...
                <select name="birthday_year" id="birthday_year" class="p-1.5 border border-gray-300 rounded-sm flex-1">
        ...
        <button type="submit"
            class="bg-green-500 text-white text-xl rounded-md px-20 py-2 hover:bg-green-600 transition ease-in block mx-auto">Sign up</button>
    </form>
